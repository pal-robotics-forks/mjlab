...
from mjlab.tasks.velocity.velocity_env_cfg import make_velocity_env_cfg, make_double_critic_velocity_env_cfg
...
def unitree_g1_double_critic_rough_env_cfg(play: bool = False) -> ManagerBasedRlEnvCfg:
  """Create Unitree G1 rough terrain velocity configuration."""
  cfg = make_double_critic_velocity_env_cfg()
...
def unitree_g1_double_critic_flat_env_cfg(play: bool = False) -> ManagerBasedRlEnvCfg:
  """Create Unitree G1 flat terrain velocity configuration."""
  cfg = unitree_g1_double_critic_rough_env_cfg(play=play)
