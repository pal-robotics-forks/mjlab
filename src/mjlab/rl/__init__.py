...
from mjlab.rl.config import RslRlMultiCriticOnPolicyRunnerCfg as RslRlMultiCriticOnPolicyRunnerCfg
...
from mjlab.rl.multi_critic_runner import MjlabMultiCriticOnPolicyRunner as MjlabMultiCriticOnPolicyRunner
